...
-- ============ Properties ============
-- agent assignment cycles through the four seeded agents.

insert into public.properties (id, name, address, type, price, area, bedrooms, bathrooms, rating, image, description, facilities, agent_id) values
  ('b0000000-0000-4000-8000-000000000001', 'Willow Creek House',
   ...
   '{Laundry,Car Parking,Wifi,Pet Center}',
  ...
  ('b0000000-0000-4000-8000-000000000002', 'Maple Grove Residence',
   ...
   '{Gym,Swimming pool,Car Parking,Wifi}',
  ...
  ('b0000000-0000-4000-8000-000000000003', 'Sunset Ridge Villa',
   ...
   '{Swimming pool,Gym,Sports Center,Wifi,Laundry}',
  ...
  ('b0000000-0000-4000-8000-000000000004', 'Palm Court Villa',
   ...
   '{Cutlery,Car Parking,Wifi,Pet Center}',
  ...
  ('b0000000-0000-4000-8000-000000000007', 'Skyline Condo 2208',
   ...
   '{Gym,Swimming pool,Wifi,Cutlery}',
   'a0000000-0000-4000-8000-000000000003'),
  ...
  ('b0000000-0000-4000-8000-000000000009', 'Cedar Park Townhome',
   ...
   '{Pet Center,Car Parking,Wifi,Sports Center}',
   'a0000000-0000-4000-8000-000000000001'),
  ...
  ('b0000000-0000-4000-8000-000000000011', 'Lakeside Modern House',
   ...
   '{Swimming pool,Gym,Wifi,Car Parking,Cutlery}',
   'a0000000-0000-4000-8000-000000000003'),
